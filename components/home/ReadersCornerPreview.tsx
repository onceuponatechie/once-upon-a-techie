    ...
    <section className="py-24 md:py-32">
      <div className="max-w-6xl mx-auto px-4">
        <ScrollReveal>
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-surface-muted/40 p-2 md:p-2.5">
            <div className="flex flex-col md:flex-row gap-4 min-h-[360px] md:min-h-[400px]">
              {/* Left side - info */}
              <div className="flex-[0.8] flex flex-col justify-center py-3 px-3 md:px-5">
              ...
              <div className="flex-[1.2] relative min-h-[260px] md:min-h-0">
                <div
